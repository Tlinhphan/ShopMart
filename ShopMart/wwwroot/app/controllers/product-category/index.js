        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            shopmart.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        shopmart.notify('Deleted success', 'success');
                        shopmart.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        shopmart.notify('Update success', 'success');
                    ...
                    error: function () {
                        shopmart.notify('Has an error in update progress', 'error');
                        shopmart.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = shopmart.unflattern(data);
